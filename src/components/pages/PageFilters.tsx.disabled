...
interface PageFiltersProps {
  ...
  onChange: (filter: Partial<PageFiltersProps['filter']>) => void;
}
...
export const PageFilters: React.FC<PageFiltersProps> = ({
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full mt-2 right-0 bg-white border border-gray-200 rounded-lg shadow-lg p-4 z-50 w-64">
